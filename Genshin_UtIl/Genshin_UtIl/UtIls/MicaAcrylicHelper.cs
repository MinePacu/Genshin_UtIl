...
{
    public static class MicaAcrylicHelper
    {
        static WindowsSystemDispatcherQueueHelper m_wsdqHelper; // See separate sample below for implementation
        public static Microsoft.UI.Composition.SystemBackdrops.MicaController m_micaController;
        public static Microsoft.UI.Composition.SystemBackdrops.SystemBackdropConfiguration m_configurationSource;

        public static Window window { get; set; }

        public static bool TrySetMicaBackdrop(bool Window_Closed_Replaced)
        {
            if (Microsoft.UI.Composition.SystemBackdrops.MicaController.IsSupported())
            {
                ...
                if (Window_Closed_Replaced == false)
